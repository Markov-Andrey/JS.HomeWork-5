...
function task7() {
	document.write(`Я понял условия задания так, 
		...
		- если нет 2-го аргумента функции - то пирамидка строится из чисел, 
		с высотой равной числу, и приращиванием чисел в ряду,<br>
		- если 2-й аргумент функции есть - символ или эмодзи, 
		то пирамидка строится на высоту первого аргумента из символов из 2-го аргнумента.
		<br><br>
